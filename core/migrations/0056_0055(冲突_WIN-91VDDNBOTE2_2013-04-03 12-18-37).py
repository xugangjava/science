...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ApplicantAchievement'
        db.create_table('core_applicantachievement', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(default='', max_length=25)),
            ('somedate', self.gf('django.db.models.fields.CharField')(default='', max_length=25)),
            ('about_this', self.gf('django.db.models.fields.CharField')(default='', max_length=800)),
            ('project_end_apply', self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['core.ProjectEndApply'])),
        ))
        db.send_create_signal('core', ['ApplicantAchievement'])

        # Deleting field 'FinalAchievement.end_apply'
        db.delete_column('core_finalachievement', 'end_apply_id')


        # Changing field 'ProjectEndApplyApprove.details'
        db.alter_column('core_projectendapplyapprove', 'details_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.ProjectApply']))

    def backwards(self, orm):
        # Deleting model 'ApplicantAchievement'
        db.delete_table('core_applicantachievement')

        # Adding field 'FinalAchievement.end_apply'
        db.add_column('core_finalachievement', 'end_apply',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, related_name='end_final_achives', null=True, to=orm['core.ProjectEndApply'], blank=True),
                      keep_default=False)


        # Changing field 'ProjectEndApplyApprove.details'
        db.alter_column('core_projectendapplyapprove', 'details_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.ProjectRollbackApply']))

    models = {
        'core.applicantachievement': {
            'Meta': {'object_name': 'ApplicantAchievement'},
            'about_this': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '800'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '25'}),
            'project_end_apply': ('django.db.models.fields.related.ForeignKey', [], {'default': "''", 'to': "orm['core.ProjectEndApply']"}),
            'somedate': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '25'})
        },
        'core.convertpdftask': {
        ...
        'core.projectapply': {
            ...
            'project_no': ('django.db.models.fields.CharField', [], {'default': "'a3126692b78b4674a2c12f2a3bb34836'", 'max_length': '25'}),
            'project_title_name': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '25'}),
        ...
        'core.projectendapply': {
            ...
            'document': ('django.db.models.fields.related.ForeignKey', [], {'default': '0', 'related_name': "'+'", 'to': "orm['core.Document']"}),
            'file_code': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '25'}),
            'final_achieve_name': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '50'}),
            'final_result_remark': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '800'}),
            'font_num': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'go_where': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '100'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'main_user_name': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '50'}),
            'plan_end_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            ...
            'result_fomat_name': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '50'}),
            'study_type_name': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '50'}),
            'unit_name_and_time': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '100'}),
            'unit_opinion': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '800'})
        },
