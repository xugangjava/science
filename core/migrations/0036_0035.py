...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProjectType.waring_day'
        db.add_column('core_projecttype', 'waring_day',
                      self.gf('django.db.models.fields.IntegerField')(default=20),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProjectType.waring_day'
        db.delete_column('core_projecttype', 'waring_day')
    ...
    models = {
        ...
        'core.projectapply': {
            ...
            'project_no': ('django.db.models.fields.CharField', [], {'default': "'de20ba21c17c47a79e3d142d096dface'", 'max_length': '25'}),
