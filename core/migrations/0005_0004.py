...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Unit.level'
        db.add_column('core_unit', 'level',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Unit.level'
        db.delete_column('core_unit', 'level')
    ...
    models = {
        ...
        'core.user': {
            ...
            'regtime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 11, 26, 0, 0)', 'blank': 'True'}),
