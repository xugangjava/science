...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'UnitProjectType.enable'
        db.delete_column('core_unitprojecttype', 'enable')

        # Adding field 'UnitProjectType.allow_apply'
        db.add_column('core_unitprojecttype', 'allow_apply',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'UnitProjectType.enable'
        db.add_column('core_unitprojecttype', 'enable',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Deleting field 'UnitProjectType.allow_apply'
        db.delete_column('core_unitprojecttype', 'allow_apply')
    ...
    models = {
        ...
        'core.message': {
            ...
            'is_show': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
        ...
        'core.projectapply': {
            ...
            'project_no': ('django.db.models.fields.CharField', [], {'default': "'83aec3fc5c584c449d8d366cb710e74e'", 'max_length': '25'}),
            'project_title_name': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '25'}),
