...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ProjectApply.project'
        db.alter_column('core_projectapply', 'project_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['core.Project']))

    def backwards(self, orm):

        # Changing field 'ProjectApply.project'
        db.alter_column('core_projectapply', 'project_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Project']))
    ...
    models = {
        ...
        'core.projectapply': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'project': ('django.db.models.fields.related.ForeignKey', [], {'default': '0', 'related_name': "'+'", 'null': 'True', 'blank': 'True', 'to': "orm['core.Project']"}),
