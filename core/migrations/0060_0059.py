...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProjectEndApply.unit'
        db.add_column('core_projectendapply', 'unit',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, related_name='+', to=orm['core.Unit']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProjectEndApply.unit'
        db.delete_column('core_projectendapply', 'unit_id')
    ...
    models = {
        ...
        'core.projectapply': {
            ...
            'project_no': ('django.db.models.fields.CharField', [], {'default': "'5635003cbf2f42b4affaed51edb3bb4a'", 'max_length': '25'}),
            'project_title_name': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '25'}),
