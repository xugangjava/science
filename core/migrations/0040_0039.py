...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ConvertPDFTask.document_id'
        db.alter_column('core_convertpdftask', 'document_id', self.gf('django.db.models.fields.IntegerField')())
        # Adding field 'Project.document'
        db.add_column('core_project', 'document',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, related_name='+', to=orm['core.Document']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Changing field 'ConvertPDFTask.document_id'
        db.alter_column('core_convertpdftask', 'document_id', self.gf('django.db.models.fields.IntegerField')(max_length=25))
        # Deleting field 'Project.document'
        db.delete_column('core_project', 'document_id')


    models = {
        'core.convertpdftask': {
            'Meta': {'object_name': 'ConvertPDFTask'},
            'document_id': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
        ...
        'core.projectapply': {
            ...
            'project_no': ('django.db.models.fields.CharField', [], {'default': "'e81b3471775f48e4bd0f08efc0a1f26c'", 'max_length': '25'}),
            'project_title_name': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '25'}),
