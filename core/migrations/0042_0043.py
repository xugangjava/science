...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Document.local_path'
        db.delete_column('core_document', 'local_path')


    def backwards(self, orm):
        # Adding field 'Document.local_path'
        db.add_column('core_document', 'local_path',
    ...
    models = {
        ...
        'core.projectapply': {
            ...
            'project_no': ('django.db.models.fields.CharField', [], {'default': "'b190255234044c4288876fadc32b491d'", 'max_length': '25'}),
            'project_title_name': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '25'}),
