...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'User.approve_time'
        db.add_column('core_user', 'approve_time',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2012, 11, 28, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'User.approve_opinion'
        db.add_column('core_user', 'approve_opinion',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2012, 11, 28, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'User.approve_time'
        db.delete_column('core_user', 'approve_time')

        # Deleting field 'User.approve_opinion'
        db.delete_column('core_user', 'approve_opinion')
    ...
    models = {
        ...
        'core.project': {
            ...
            'status': ('django.db.models.fields.related.ForeignKey', [], {'default': '0', 'related_name': "'+'", 'to': "orm['core.ProjectStatus']"})
        },
        'core.projectstatus': {
            'Meta': {'object_name': 'ProjectStatus'},
            'approve': ('django.db.models.fields.related.ForeignKey', [], {'default': '0', 'related_name': "'+'", 'null': 'True', 'blank': 'True', 'to': "orm['core.Approve']"}),
        ...
        'core.unit': {
            ...
            'regtime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 11, 28, 0, 0)', 'blank': 'True'}),
            'status': ('django.db.models.fields.IntegerField', [], {'default': '0'})
        },
        'core.user': {
            'Meta': {'object_name': 'User'},
            'approve_opinion': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 11, 28, 0, 0)', 'blank': 'True'}),
            'approve_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 11, 28, 0, 0)', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
