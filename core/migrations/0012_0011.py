...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Project.applicant_time'
        db.add_column('core_project', 'applicant_time',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True),
                      keep_default=False)

        # Adding field 'Project.unit'
        db.add_column('core_project', 'unit',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, related_name='+', to=orm['core.Unit']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Project.applicant_time'
        db.delete_column('core_project', 'applicant_time')

        # Deleting field 'Project.unit'
        db.delete_column('core_project', 'unit_id')
