...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ConvertPDFTask.document_id'
        db.delete_column('core_convertpdftask', 'document_id')

        # Adding field 'ConvertPDFTask.documentid'
        db.add_column('core_convertpdftask', 'documentid',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'ConvertPDFTask.document_id'
        db.add_column('core_convertpdftask', 'document_id',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Deleting field 'ConvertPDFTask.documentid'
        db.delete_column('core_convertpdftask', 'documentid')
    ...
    models = {
        ...
        'core.projectapply': {
            ...
            'project_no': ('django.db.models.fields.CharField', [], {'default': "'9b21edd747bf47149f55797492700aae'", 'max_length': '25'}),
            'project_title_name': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '25'}),
