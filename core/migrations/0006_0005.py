...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Unit.regtime'
        db.add_column('core_unit', 'regtime',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2012, 11, 27, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Unit.regtime'
        db.delete_column('core_unit', 'regtime')
    ...
    models = {
        ...
        'core.unit': {
            ...
            'regtime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 11, 27, 0, 0)', 'blank': 'True'}),
