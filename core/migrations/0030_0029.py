...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Document.remark'
        db.delete_column('core_document', 'remark')

        # Deleting field 'Document.rel_path'
        db.delete_column('core_document', 'rel_path')
    ...
    def backwards(self, orm):
        ...
        db.create_table('core_expertapprove', (
            ...
            ('project_apply', self.gf('django.db.models.fields.related.ForeignKey')(default=0, related_name='+', to=orm['core.ProjectApply'])),
        ))
        ...
        # Adding field 'Document.remark'
        db.add_column('core_document', 'remark',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=25),
                      keep_default=False)

        # Adding field 'Document.rel_path'
        db.add_column('core_document', 'rel_path',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=25),
                      keep_default=False)
