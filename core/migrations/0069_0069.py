...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ProjectApply.project_area_name'
        db.add_column('core_projectapply', 'project_area_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=25),
                      keep_default=False)

        # Adding field 'ProjectApply.teacher_name_ss'
        db.add_column('core_projectapply', 'teacher_name_ss',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=25),
                      keep_default=False)

        # Adding field 'ProjectApply.teacher_name_bs'
        db.add_column('core_projectapply', 'teacher_name_bs',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=25),
                      keep_default=False)

        # Deleting field 'ProjectActor.job'
        db.delete_column('core_projectactor', 'job')

        # Adding field 'ProjectActor.job_zw'
        db.add_column('core_projectactor', 'job_zw',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=25),
                      keep_default=False)

        # Adding field 'ProjectActor.job_zc'
        db.add_column('core_projectactor', 'job_zc',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=25),
                      keep_default=False)
        ...
        # Adding field 'Project.project_area_name'
        db.add_column('core_project', 'project_area_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=25),
                      keep_default=False)

        # Adding field 'Project.teacher_name_ss'
        db.add_column('core_project', 'teacher_name_ss',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=25),
                      keep_default=False)

        # Adding field 'Project.teacher_name_bs'
        db.add_column('core_project', 'teacher_name_bs',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=25),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'ProjectApply.project_area_name'
        db.delete_column('core_projectapply', 'project_area_name')

        # Deleting field 'ProjectApply.teacher_name_ss'
        db.delete_column('core_projectapply', 'teacher_name_ss')

        # Deleting field 'ProjectApply.teacher_name_bs'
        db.delete_column('core_projectapply', 'teacher_name_bs')

        # Adding field 'ProjectActor.job'
        db.add_column('core_projectactor', 'job',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=25),
                      keep_default=False)

        # Deleting field 'ProjectActor.job_zw'
        db.delete_column('core_projectactor', 'job_zw')

        # Deleting field 'ProjectActor.job_zc'
        db.delete_column('core_projectactor', 'job_zc')
        ...
        # Deleting field 'Project.project_area_name'
        db.delete_column('core_project', 'project_area_name')

        # Deleting field 'Project.teacher_name_ss'
        db.delete_column('core_project', 'teacher_name_ss')

        # Deleting field 'Project.teacher_name_bs'
        db.delete_column('core_project', 'teacher_name_bs')
    ...
    models = {
        ...
        'core.project': {
            ...
            'project_area_name': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '25'}),
            ...
            'teacher_name_bs': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '25'}),
            'teacher_name_ss': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '25'}),
        ...
        'core.projectactor': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'job_zc': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '25'}),
            'job_zw': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '25'}),
        ...
        'core.projectapply': {
            ...
            'expert_approve_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'expert_opinion': ('django.db.models.fields.TextField', [], {'default': "''", 'max_length': '200'}),
            'expert_percent': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'expert_success': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'feasibility_desc': ('django.db.models.fields.TextField', [], {'default': "''", 'max_length': '500'}),
            ...
            'print_money_dec': ('django.db.models.fields.TextField', [], {'default': "''", 'max_length': '200'}),
            'project_area_name': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '25'}),
            'project_comple_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            ...
            'project_no': ('django.db.models.fields.CharField', [], {'default': "'d93fd79860c347f4acce64f6fdb74335'", 'max_length': '25'}),
            'project_title_name': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '25'}),
        ...
        'core.projectapplyexpert': {
            'Meta': {'object_name': 'ProjectApplyExpert'},
            'apply': ('django.db.models.fields.related.ForeignKey', [], {'default': '0', 'related_name': "'+'", 'to': "orm['core.ProjectApply']"}),
            'expert': ('django.db.models.fields.related.ForeignKey', [], {'default': '0', 'related_name': "'+'", 'to': "orm['core.User']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
        ...
        'core.user': {
            ...
            'last_activity_ip': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '25'}),
