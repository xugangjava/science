...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ProjectExChange.applicanttime'
        db.delete_column('core_projectexchange', 'applicanttime')

        # Adding field 'ProjectExChange.applicant_time'
        db.add_column('core_projectexchange', 'applicant_time',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True),
                      keep_default=False)

        # Adding field 'ProjectExChange.project_name'
        db.add_column('core_projectexchange', 'project_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=25),
                      keep_default=False)

        # Adding field 'ProjectExChange.project_type'
        db.add_column('core_projectexchange', 'project_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, related_name='+', to=orm['core.ProjectType']),
                      keep_default=False)

        # Adding field 'ProjectExChange.project_no'
        db.add_column('core_projectexchange', 'project_no',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=25),
                      keep_default=False)

        # Adding field 'ProjectExChange.project_status'
        db.add_column('core_projectexchange', 'project_status',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'ProjectExChange.applicanttime'
        db.add_column('core_projectexchange', 'applicanttime',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True),
                      keep_default=False)

        # Deleting field 'ProjectExChange.applicant_time'
        db.delete_column('core_projectexchange', 'applicant_time')

        # Deleting field 'ProjectExChange.project_name'
        db.delete_column('core_projectexchange', 'project_name')

        # Deleting field 'ProjectExChange.project_type'
        db.delete_column('core_projectexchange', 'project_type_id')

        # Deleting field 'ProjectExChange.project_no'
        db.delete_column('core_projectexchange', 'project_no')

        # Deleting field 'ProjectExChange.project_status'
        db.delete_column('core_projectexchange', 'project_status')
