...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'User.study_type_name'
        db.add_column('core_user', 'study_type_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=25),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'User.study_type_name'
        db.delete_column('core_user', 'study_type_name')
    ...
    models = {
        ...
        'core.projectapply': {
            ...
            'project_no': ('django.db.models.fields.CharField', [], {'default': "'177724c4a9734981824316f55e27a589'", 'max_length': '25'}),
            'project_title_name': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '25'}),
