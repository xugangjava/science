...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'User.login_count'
        db.add_column('core_user', 'login_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'User.last_activity_ip'
        db.add_column('core_user', 'last_activity_ip',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=25),
                      keep_default=False)

        # Adding field 'User.last_activity_date'
        db.add_column('core_user', 'last_activity_date',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(1950, 1, 1, 0, 0)),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'User.login_count'
        db.delete_column('core_user', 'login_count')

        # Deleting field 'User.last_activity_ip'
        db.delete_column('core_user', 'last_activity_ip')

        # Deleting field 'User.last_activity_date'
        db.delete_column('core_user', 'last_activity_date')
    ...
    models = {
        ...
        'core.projectapply': {
            ...
            'project_no': ('django.db.models.fields.CharField', [], {'default': "'0b43202b3d174bf6ab4fac04fb22cd10'", 'max_length': '25'}),
            'project_title_name': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '25'}),
