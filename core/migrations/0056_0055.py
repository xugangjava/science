...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProjectEndApply.status'
        db.add_column('core_projectendapply', 'status',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProjectEndApply.status'
        db.delete_column('core_projectendapply', 'status')
    ...
    models = {
        ...
        'core.projectapply': {
            ...
            'project_no': ('django.db.models.fields.CharField', [], {'default': "'ce5e2af9322846fbb46550f80255388d'", 'max_length': '25'}),
            'project_title_name': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '25'}),
