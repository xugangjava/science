...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ConvertPDFTask'
        db.create_table('core_convertpdftask', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('document_id', self.gf('django.db.models.fields.IntegerField')(default='', max_length=25)),
        ))
        db.send_create_signal('core', ['ConvertPDFTask'])

        # Adding field 'Document.pdf'
        db.add_column('core_document', 'pdf',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=25),
                      keep_default=False)

        # Adding field 'Document.doc'
        db.add_column('core_document', 'doc',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=25),
                      keep_default=False)

        # Adding field 'Document.converted'
        db.add_column('core_document', 'converted',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Document.converted_err'
        db.add_column('core_document', 'converted_err',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)

        # Adding field 'Message.is_read'
        db.add_column('core_message', 'is_read',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'ConvertPDFTask'
        db.delete_table('core_convertpdftask')

        # Deleting field 'Document.pdf'
        db.delete_column('core_document', 'pdf')

        # Deleting field 'Document.doc'
        db.delete_column('core_document', 'doc')

        # Deleting field 'Document.converted'
        db.delete_column('core_document', 'converted')

        # Deleting field 'Document.converted_err'
        db.delete_column('core_document', 'converted_err')

        # Deleting field 'Message.is_read'
        db.delete_column('core_message', 'is_read')


    models = {
        'core.convertpdftask': {
            'Meta': {'object_name': 'ConvertPDFTask'},
            'document_id': ('django.db.models.fields.IntegerField', [], {'default': "''", 'max_length': '25'}),
        ...
        'core.projectapply': {
            ...
            'project_no': ('django.db.models.fields.CharField', [], {'default': "'7f3de0eedc3c4d25b768703e040cd412'", 'max_length': '25'}),
            'project_title_name': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '25'}),
