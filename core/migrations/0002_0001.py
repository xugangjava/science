...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProjectApplyApprove.expert_support'
        db.add_column('core_projectapplyapprove', 'expert_support',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50,null=True, blank=True),
                      keep_default=False)

        # Adding field 'ProjectApplyApprove.expert_percent'
        db.add_column('core_projectapplyapprove', 'expert_percent',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50,null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProjectApplyApprove.expert_support'
        db.delete_column('core_projectapplyapprove', 'expert_support')

        # Deleting field 'ProjectApplyApprove.expert_percent'
        db.delete_column('core_projectapplyapprove', 'expert_percent')
    ...
    models = {
        ...
        'core.projectapply': {
            ...
            'document': ('django.db.models.fields.related.ForeignKey', [], {'default': '0', 'related_name': "'+'", 'to': "orm['core.Document']"}),
            'expert_approve_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'expert_names': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '500'}),
            'expert_opinion': ('django.db.models.fields.TextField', [], {'default': "''", 'max_length': '200'}),
            ...
            'project_no': ('django.db.models.fields.CharField', [], {'default': "'aa04f4074905412f8be92dd8d5a3b6c6'", 'max_length': '25'}),
            'project_title_name': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '25'}),
        ...
        'core.projectapplyapprove': {
            ...
            'expert_percent': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '50'}),
            'expert_support': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '50'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'core.user': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'identitycard': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '50'}),
            ...
            'jobunit': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '50'}),
            ...
            'orgcode': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '50'}),
