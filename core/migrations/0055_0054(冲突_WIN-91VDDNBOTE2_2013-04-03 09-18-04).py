...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('core_projectendapply', (
            ...
            ('final_achieve_name', self.gf('django.db.models.fields.CharField')(default='', max_length=50)),
            ('main_user_name', self.gf('django.db.models.fields.CharField')(default='', max_length=50)),
            ('result_fomat_name', self.gf('django.db.models.fields.CharField')(default='', max_length=50)),
            ...
            ('plan_end_time', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('font_num', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('unit_name_and_time', self.gf('django.db.models.fields.CharField')(default='', max_length=100)),
            ('go_where', self.gf('django.db.models.fields.CharField')(default='', max_length=100)),
            ('final_result_remark', self.gf('django.db.models.fields.CharField')(default='', max_length=800)),
            ('unit_opinion', self.gf('django.db.models.fields.CharField')(default='', max_length=800)),
        ...
        db.create_table('core_projectendapplyapprove', (
            ...
            ('details', self.gf('django.db.models.fields.related.ForeignKey')(default=0, related_name='+', to=orm['core.ProjectRollbackApply'])),
        ))
        ...
        db.add_column('core_finalachievement', 'end_apply',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, related_name='end_final_achives', null=True, blank=True, to=orm['core.ProjectEndApply']),
                      keep_default=False)
    ...
    models = {
        ...
        'core.finalachievement': {
            ...
            'end_apply': ('django.db.models.fields.related.ForeignKey', [], {'default': '0', 'related_name': "'end_final_achives'", 'null': 'True', 'blank': 'True', 'to': "orm['core.ProjectEndApply']"}),
        ...
        'core.projectapply': {
            ...
            'project_no': ('django.db.models.fields.CharField', [], {'default': "'b8adeed632b744eeb86fc5497fbc0c43'", 'max_length': '25'}),
            'project_title_name': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '25'}),
