...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ProjectRollbackApply'
        db.create_table('core_projectrollbackapply', (
        ...
        db.send_create_signal('core', ['ProjectRollbackApply'])

        # Deleting field 'Unit.project_type'
        db.delete_column('core_unit', 'project_type_id')


    def backwards(self, orm):
        # Deleting model 'ProjectRollbackApply'
        db.delete_table('core_projectrollbackapply')

        # Adding field 'Unit.project_type'
        db.add_column('core_unit', 'project_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, related_name='+', null=True, to=orm['core.ProjectType'], blank=True),
                      keep_default=False)
    ...
    models = {
        ...
        'core.projectapply': {
            ...
            'project_no': ('django.db.models.fields.CharField', [], {'default': "'b05ee41c02e9431cb084102741e459a7'", 'max_length': '25'}),
            'project_title_name': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '25'}),
