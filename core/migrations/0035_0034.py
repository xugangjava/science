...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProjectActor.degree'
        db.add_column('core_projectactor', 'degree',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=25),
                      keep_default=False)

        # Adding field 'ProjectApply.total_money'
        db.add_column('core_projectapply', 'total_money',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'LevelAchievement.atype'
        db.add_column('core_levelachievement', 'atype',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProjectActor.degree'
        db.delete_column('core_projectactor', 'degree')

        # Deleting field 'ProjectApply.total_money'
        db.delete_column('core_projectapply', 'total_money')

        # Deleting field 'LevelAchievement.atype'
        db.delete_column('core_levelachievement', 'atype')
    ...
    models = {
        ...
        'core.projectapply': {
            ...
            'project_no': ('django.db.models.fields.CharField', [], {'default': "'88af5b101322431d9e0257ee561cc972'", 'max_length': '25'}),
