...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProjectApply.project_comple_time'
        db.add_column('core_projectapply', 'project_comple_time',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=25),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProjectApply.project_comple_time'
        db.delete_column('core_projectapply', 'project_comple_time')
    ...
    models = {
        ...
        'core.projectapply': {
            ...
            'print_money': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'print_money_dec': ('django.db.models.fields.TextField', [], {'default': "''", 'max_length': '200'}),
            'project_comple_time': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '25'}),
            ...
            'project_no': ('django.db.models.fields.CharField', [], {'default': "'af9ee2d8b5374792b3e498173d018434'", 'max_length': '25'}),
            'project_title_name': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '25'}),
