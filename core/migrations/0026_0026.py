...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProjectExChange.unit'
        db.add_column('core_projectexchange', 'unit',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, related_name='+', to=orm['core.Unit']),
                      keep_default=False)

        # Adding field 'ProjectApply.unit'
        db.add_column('core_projectapply', 'unit',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, related_name='+', to=orm['core.Unit']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProjectExChange.unit'
        db.delete_column('core_projectexchange', 'unit_id')

        # Deleting field 'ProjectApply.unit'
        db.delete_column('core_projectapply', 'unit_id')
