...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Document.version_no'
        db.delete_column('core_document', 'version_no')

        # Adding field 'Document.project_no'
        db.add_column('core_document', 'project_no',
    ...
    def backwards(self, orm):
        # Adding field 'Document.version_no'
        db.add_column('core_document', 'version_no',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=25),
                      keep_default=False)

        # Deleting field 'Document.project_no'
        db.delete_column('core_document', 'project_no')
    ...
    models = {
        ...
        'core.projectapply': {
            ...
            'project_no': ('django.db.models.fields.CharField', [], {'default': "'0d3522e495ef42b8b3a3bcdfb01e7b0f'", 'max_length': '25'}),
            'project_title_name': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '25'}),
