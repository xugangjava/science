...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ProjectApply.project_comple_time'
        db.alter_column('core_projectapply', 'project_comple_time', self.gf('django.db.models.fields.DateTimeField')())

    def backwards(self, orm):

        # Changing field 'ProjectApply.project_comple_time'
        db.alter_column('core_projectapply', 'project_comple_time', self.gf('django.db.models.fields.CharField')(max_length=25))
    ...
    models = {
        ...
        'core.projectapply': {
            ...
            'project_no': ('django.db.models.fields.CharField', [], {'default': "'4940da5167d84befa606bdbccf29913a'", 'max_length': '25'}),
            'project_title_name': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '25'}),
