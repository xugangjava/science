...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ProjectRollbackApplyApprove.details'
        db.alter_column('core_projectrollbackapplyapprove', 'details_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.ProjectRollbackApply']))
        ...
        # Adding field 'ProjectApply.project_id'
        db.add_column('core_projectapply', 'project_id',
    ...
    def backwards(self, orm):
        ...
        # Changing field 'ProjectRollbackApplyApprove.details'
        db.alter_column('core_projectrollbackapplyapprove', 'details_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.ProjectExChange']))
        ...
        # Deleting field 'ProjectApply.project_id'
    ...
    models = {
        ...
        'core.projectapply': {
            ...
            'project_no': ('django.db.models.fields.CharField', [], {'default': "'cd6b783689e74801a8a3f3c4c3198dd0'", 'max_length': '25'}),
            'project_title_name': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '25'}),
