...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProjectExChange.status'
        db.add_column('core_projectexchange', 'status',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProjectExChange.status'
        db.delete_column('core_projectexchange', 'status')
