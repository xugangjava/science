...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ProjectApplyExpert'
        db.create_table('core_projectapplyexpert', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('expert', self.gf('django.db.models.fields.related.ForeignKey')(default=0, related_name='+', to=orm['core.User'])),
            ('apply', self.gf('django.db.models.fields.related.ForeignKey')(default=0, related_name='+', to=orm['core.ProjectApply'])),
        ))
        db.send_create_signal('core', ['ProjectApplyExpert'])
    ...
    def backwards(self, orm):
        # Deleting model 'ProjectApplyExpert'
        db.delete_table('core_projectapplyexpert')
    ...
    models = {
        ...
        'core.projectapply': {
            ...
            'project_no': ('django.db.models.fields.CharField', [], {'default': "'785c0d85d352435c817fdd0bd0d0c4f4'", 'max_length': '25'}),
            'project_title_name': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '25'}),
