...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Unit.project_type'
        db.alter_column('core_unit', 'project_type_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['core.ProjectType']))
        # Deleting field 'Project.proposer'
        db.delete_column('core_project', 'proposer_id')

        # Adding field 'Project.applicant'
        db.add_column('core_project', 'applicant',
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Unit.project_type'
        db.alter_column('core_unit', 'project_type_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.ProjectType']))
        # Adding field 'Project.proposer'
        db.add_column('core_project', 'proposer',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, related_name='+', to=orm['core.User']),
                      keep_default=False)

        # Deleting field 'Project.applicant'
        db.delete_column('core_project', 'applicant_id')
