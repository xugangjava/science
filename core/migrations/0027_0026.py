...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ExpertApprove.project'
        db.delete_column('core_expertapprove', 'project_id')

        # Adding field 'ExpertApprove.project_apply'
        db.add_column('core_expertapprove', 'project_apply',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, related_name='+', to=orm['core.ProjectApply']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'ExpertApprove.project'
        db.add_column('core_expertapprove', 'project',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, related_name='+', to=orm['core.Project']),
                      keep_default=False)

        # Deleting field 'ExpertApprove.project_apply'
        db.delete_column('core_expertapprove', 'project_apply_id')
