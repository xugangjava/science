...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ProjectRollbackApplyApprove'
        db.create_table('core_projectrollbackapplyapprove', (
        ...
        db.send_create_signal('core', ['ProjectRollbackApplyApprove'])

        # Deleting field 'ProjectExChange.project'
        db.delete_column('core_projectexchange', 'project_id')

        # Adding field 'ProjectExChange.project_apply'
        db.add_column('core_projectexchange', 'project_apply',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, related_name='+', to=orm['core.ProjectApply']),
                      keep_default=False)

        # Deleting field 'ProjectRollbackApply.project'
        db.delete_column('core_projectrollbackapply', 'project_id')

        # Adding field 'ProjectRollbackApply.project_apply'
        db.add_column('core_projectrollbackapply', 'project_apply',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, related_name='+', to=orm['core.ProjectApply']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'ProjectRollbackApplyApprove'
        db.delete_table('core_projectrollbackapplyapprove')

        # Adding field 'ProjectExChange.project'
        db.add_column('core_projectexchange', 'project',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, related_name='+', to=orm['core.Project']),
                      keep_default=False)

        # Deleting field 'ProjectExChange.project_apply'
        db.delete_column('core_projectexchange', 'project_apply_id')

        # Adding field 'ProjectRollbackApply.project'
        db.add_column('core_projectrollbackapply', 'project',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, related_name='+', to=orm['core.Project']),
                      keep_default=False)

        # Deleting field 'ProjectRollbackApply.project_apply'
        db.delete_column('core_projectrollbackapply', 'project_apply_id')
    ...
    models = {
        ...
        'core.projectapply': {
            ...
            'project_no': ('django.db.models.fields.CharField', [], {'default': "'5fabc2704b9f4689921651df0880ee09'", 'max_length': '25'}),
            'project_title_name': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '25'}),
