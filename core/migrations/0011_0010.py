...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ProjectTran.content'
        db.delete_column('core_projecttran', 'content')

        # Adding field 'ProjectTran.reason'
        db.add_column('core_projecttran', 'reason',
                      self.gf('django.db.models.fields.TextField')(default='', max_length=200),
                      keep_default=False)

        # Adding field 'ProjectTran.approve_opinion'
        db.add_column('core_projecttran', 'approve_opinion',
                      self.gf('django.db.models.fields.TextField')(default='', max_length=200),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'ProjectTran.content'
        db.add_column('core_projecttran', 'content',
                      self.gf('django.db.models.fields.TextField')(default='', max_length=200),
                      keep_default=False)

        # Deleting field 'ProjectTran.reason'
        db.delete_column('core_projecttran', 'reason')

        # Deleting field 'ProjectTran.approve_opinion'
        db.delete_column('core_projecttran', 'approve_opinion')
    ...
    models = {
        ...
        'core.projecttran': {
            ...
            'backward': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'forward': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'project': ('django.db.models.fields.related.ForeignKey', [], {'default': '0', 'related_name': "'+'", 'to': "orm['core.Project']"}),
            'reason': ('django.db.models.fields.TextField', [], {'default': "''", 'max_length': '200'}),
