...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'UnitProjectType'
        db.delete_table('core_unitprojecttype')

        # Adding model 'UnitLimitProjectType'
        db.create_table('core_unitlimitprojecttype', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('unit', self.gf('django.db.models.fields.related.ForeignKey')(default=0, related_name='+', to=orm['core.Unit'])),
            ('project_type', self.gf('django.db.models.fields.related.ForeignKey')(default=0, related_name='+', to=orm['core.ProjectType'])),
        ))
        db.send_create_signal('core', ['UnitLimitProjectType'])

        # Deleting field 'Message.is_show'
        db.delete_column('core_message', 'is_show')

        # Adding field 'ProjectType.max_project_num'
        db.add_column('core_projecttype', 'max_project_num',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Adding model 'UnitProjectType'
        db.create_table('core_unitprojecttype', (
            ('unit', self.gf('django.db.models.fields.related.ForeignKey')(default=0, related_name='+', to=orm['core.Unit'])),
            ('allow_apply', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('project_type', self.gf('django.db.models.fields.related.ForeignKey')(default=0, related_name='+', to=orm['core.ProjectType'])),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal('core', ['UnitProjectType'])

        # Deleting model 'UnitLimitProjectType'
        db.delete_table('core_unitlimitprojecttype')

        # Adding field 'Message.is_show'
        db.add_column('core_message', 'is_show',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'ProjectType.max_project_num'
        db.delete_column('core_projecttype', 'max_project_num')
    ...
    models = {
        ...
        'core.projectapply': {
            ...
            'project_no': ('django.db.models.fields.CharField', [], {'default': "'74745c44d6e34e60ab1093ebbdb4002a'", 'max_length': '25'}),
            'project_title_name': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '25'}),
