...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ProjectEndApply.project_id'
        db.delete_column('core_projectendapply', 'project_id')

        # Adding field 'ProjectEndApply.project'
        db.add_column('core_projectendapply', 'project',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'ProjectEndApply.applicant'
        db.add_column('core_projectendapply', 'applicant',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, related_name='+', to=orm['core.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'ProjectEndApply.project_id'
        db.add_column('core_projectendapply', 'project_id',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Deleting field 'ProjectEndApply.project'
        db.delete_column('core_projectendapply', 'project')

        # Deleting field 'ProjectEndApply.applicant'
        db.delete_column('core_projectendapply', 'applicant_id')
    ...
    models = {
        ...
        'core.projectapply': {
            ...
            'project_no': ('django.db.models.fields.CharField', [], {'default': "'ff7547402a77408b877c545a571894b4'", 'max_length': '25'}),
            'project_title_name': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '25'}),
